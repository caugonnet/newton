...
class TestSolverKaminoConfig(unittest.TestCase):
    ...
    def test_02_lox_config_validation(self):
        ...
        for preconditioner in ("incomplete_ldlt", "two_level", "block_jacobi", "jacobi"):
        ...
        with self.assertRaisesRegex(ValueError, "incomplete_ldlt.*two_level.*block_jacobi.*jacobi"):
