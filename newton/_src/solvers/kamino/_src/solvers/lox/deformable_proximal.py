...
def update_membrane_proximal(
    ...
    candidate_0 = deformation_0
    candidate_1 = deformation_1
    metric_primal_0, metric_primal_1 = _apply_metric(
        center_0 - candidate_0,
        center_1 - candidate_1,
        frozen_area_gradient_0,
        frozen_area_gradient_1,
        rest_area * mu,
        area_scale,
    )
    deformation_0 = previous_0 + proximal_relaxation * (candidate_0 - previous_0)
    deformation_1 = previous_1 + proximal_relaxation * (candidate_1 - previous_1)
