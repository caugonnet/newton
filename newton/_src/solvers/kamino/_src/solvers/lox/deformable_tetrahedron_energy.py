...
@wp.func
def tet_stable_neo_hookean_projected_hessian(
    deformation: wp.mat33,
    rest_volume: float,
    k_mu: float,
    k_lambda: float,
    ...
    """Project the full LOX Hessian onto an eigenvalue floor."""
    return tet_stable_neo_hookean_spectral_metrics(
        deformation,
        rest_volume,
        k_mu,
        k_lambda,
...
@wp.func
def tet_stable_neo_hookean_majorizing_metric(
    deformation: wp.mat33,
    rest_volume: float,
    k_mu: float,
    k_lambda: float,
    ...
    """Build a PSD metric with a frozen negative-curvature-relative margin."""
    return tet_stable_neo_hookean_spectral_metrics(
        deformation,
        rest_volume,
        k_mu,
